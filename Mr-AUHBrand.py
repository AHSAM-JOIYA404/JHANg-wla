...
\x1b[1;97m====================================================== 
\033[1;37m[] Author        : \033[1;32mAHSAM UL HAQ
\033[1;37m[] Github        : \033[1;32mMR-AUH404
\033[1;37m[] Status        : \033[1;32mPAID
\033[1;37m[] Version      : \033[1;32m3.0.1
...
def main_apv():
    ...
    try:
        ...
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923411471937?text=HELLO%20AHSAMULHAQ,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM %20%20MY%20%20KEY%20%20:%20')

    r1 = requests.get('https://raw.githubusercontent.com/MR-AUH404/404/main/approved.txt').text
    if key1 in r1:
        main()
    else:
        os.system('clear')
        ...
        print ('_____________________________________________________')
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923411471937?text=HELLO%20AHSAMULHAQ,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM✓✓%20%20%20%20%20MY%20%20KEY%20%20:%20')
